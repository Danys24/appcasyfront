...
import {obtenerResultadosPorIdPasoIdCiclo, obtenerResultadosPorIdCasoIdCiclo} from '../servicios/resultadoService.js';
        ...
        {filas.map((fil,index) => (
            <tr key={index}>
                ...
                listaResultados.map((resultado) => (
                  <>
                    <td><textarea>{resultado.observacion}</textarea></td>
                    <td>
                        <input className='anexo-paso' type="file" />  
                    </td>
                    <td>
