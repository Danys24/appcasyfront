...
function CrearSet() {
  ...
  return (
    <div>
      {!crearSetPrueba && (
        <button className='boton-crear-set' onClick={() => setCrearSetPrueba(true)}>Crear Set Prueba</button>
      )}
          ...
          {listaSets.map((objeto) => (
            <div className='contenedor-set-item'>
                ...
                <div className='acciones'>
                  <button className='btn-accion-set' onClick={() => setCrearSetPrueba(true)}>Editar</button>
                  <Link className='btn-accion-set' to={`/set/${objeto.nombre}`}>Ejecutar</Link>
                  <button className='btn-accion-set'>Eliminar</button>
                </div>
